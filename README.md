...
- 🌱 J'apprends en parallele le **Java** et le **DiscordJS** via un la création d'un [**Plugin**](https://github.com/BenJ4368/BriochePlugin), et de mon propre [**Bot Discord**](https://github.com/BenJ4368/Merlin).
